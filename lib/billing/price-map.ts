...
const entries: [string, Plan][] = [
  ...
  [process.env.STRIPE_PRICE_PRESENCIA_MONTHLY ?? '', 'BASIC'],
  [process.env.STRIPE_PRICE_B2B_GROWTH_MONTHLY ?? '', 'PRO'],
  [process.env.STRIPE_PRICE_ELITE_MONTHLY ?? '', 'GROWTH'],
  [process.env.STRIPE_PRICE_PARTNER_MONTHLY ?? '', 'PREMIUM'],
]
